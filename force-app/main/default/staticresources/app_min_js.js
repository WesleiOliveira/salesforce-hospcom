...
ssc.formBinder = function() {
	return {
		bind: function(a, b) {
			var c;
			try {
				if (c = $("#" + a), c.is('input:not(":button,:checkbox,:radio,:file"), textarea') || c.is("select")) {
					if (c.val(b), "none" == c.css("display") && void 0 != c.attr("data-widgettype")) {
				...
				} else c.is("input:checkbox") ? c.prop("checked", "boolean" == typeof b && b || "string" == typeof b && "on" == b) : $("input[name=" + a + "]").is("input:radio") ? $('input[name="' + a + '"][value="' + b + '"]').prop("checked", !0) : c.is("input:file");
				return c
			} catch (a) {}
		},
		isNewValue: function(a, b) {
			var c;
			try {
				return c = $("#" + a), c.is('input:not(":button,:checkbox,:radio,:file"), textarea') || c.is("select") ? c.val() != b : c.is("input:checkbox") ? c.prop("checked") != ("boolean" == typeof b && b) || "string" == typeof b && "on" == b : $("input[name=" + a + "]").is("input:radio") ? 1 != $('input[name="' + a + '"][value="' + b + '"]').prop("checked") : (c.is("input:file") && (b = JSON.parse(b), b.length >= 0 && (c.parents("td").find(".uploading").find("ul").empty(), c.data("files", b)), $.each(b, function(a, b) {
					var d = $("<li></li>");
					c.parents("td").find(".uploading").find("ul").append(d), d.fileUploader({
						file: {
							name: b.file
						}
					})
				}), b.length > 0 ? (c.closest("div").hide(), c.parents("td").find(".uploading").show()) : (c.closest("div").show(), c.parents("td").find(".uploading").hide())), !1)
			} catch (a) {}
		}
	}
}();
...
! function() {
	...
	! function() {
		...
		e = function(e, t, n) {
			...
			if (o._eak_seen = r, i[e]) return i[e];
			if (i[e] = {}, !r[e]) throw new Error("Could not find module " + e);
			for (var n, a = r[e], s = a.deps, c = a.callback, l = [], u = 0, f = s.length; f > u; u++) l.push("exports" === s[u] ? n = {} : t(function(t) {
		...
		function n(e) {
			...
			return new t(function(t, n) {
				...
				var i, a = [],
					s = e.length;
				0 === s && t([]);
				for (var c = 0; c < e.length; c++) i = e[c], i && r(i.then) ? i.then(function(e) {
					return function(t) {
						o(e, t)
					}
				}(c), n) : o(c, i)
		...
		var o, r = "undefined" != typeof window ? window : {},
		...
		function c(e) {
			if (!S(e)) throw new TypeError("You must pass a resolver function as the first argument to the promise constructor");
		...
		function f(e, t, n, o) {
			var r = e._subscribers,
				i = r.length;
			r[i] = t, r[i + C] = n, r[i + D] = o
		}

		function d(e, t) {
			for (var n, o, r = e._subscribers, i = e._detail, a = 0; a < r.length; a += 3) n = r[a], o = r[a + t], u(t, n, o, i);
			e._subscribers = null
		}
		...
		function m(e, t) {
			...
			try {
				...
				if (w(t) && (o = t.then, S(o))) return o.call(t, function(o) {
					return !!n || (n = !0, void(t !== o ? p(e, o) : h(e, o)))
				}, function(t) {
					return !!n || (n = !0, void v(e, t))
				}), !0
			} catch (t) {
				return !!n || (v(e, t), !0)
			}
		...
		function h(e, t) {
			e._state === O && (e._state = A, e._detail = t, y.async(g, e))
		}

		function v(e, t) {
			e._state === O && (e._state = A, e._detail = t, y.async(b, e))
		}
		...
		}, c.all = _, c.race = x, c.resolve = k, c.reject = I, s.Promise = c
		...
		e.objectOrFunction = t, e.isFunction = n, e.isArray = o, e.now = r
...
function() {
	...
	function() {
		function e(e) {
			...
			if (e)
				for (var o in e) n[o] = e[o];
			return n.keyPrefix = n.name + "/", t._dbInfo = n, m.resolve()
		}
					...
					n.ready().then(function() {
						try {
							for (var r = n._dbInfo.keyPrefix, i = r.length, a = p.length, s = 0; a > s; s++) {
								var l = p.key(s),
									u = p.getItem(l);
								if (u && (u = c(u)), void 0 !== (u = e(u, l.substring(i)))) return void t(u)
							}
							t()
						} catch (e) {
							o(e)
			...
			var n = this,
				o = new m(function(t, o) {
					n.ready().then(function() {
						...
						o && (o = o.substring(r.keyPrefix.length)), t(o)
					}).catch(o)
				});
			return d(o, t), o
		}
		...
		function i(e) {
			var t = this,
				n = new m(function(e, n) {
					t.ready().then(function() {
						for (var n = t._dbInfo, o = p.length, r = [], i = 0; o > i; i++) 0 === p.key(i).indexOf(n.keyPrefix) && r.push(p.key(i).substring(n.keyPrefix.length));
						e(r)
					}).catch(n)
				});
			return d(n, e), n
		...
		function c(e) {
			if (e.substring(0, v) !== h) return JSON.parse(e);
			for (var t = e.substring(A), n = e.substring(v, A), o = new ArrayBuffer(2 * t.length), r = new Uint16Array(o), i = t.length - 1; i >= 0; i--) r[i] = t.charCodeAt(i);
			switch (n) {
				case g:
					return o;
				case b:
		...
		function l(e) {
			...
			try {
				...
				for (var o = 0; o < n.length; o++) t += String.fromCharCode(n[o])
			}
			return t
		}
		...
		function u(e, t) {
			...
			if (e && (n = e.toString()), e && ("[object ArrayBuffer]" === e.toString() || e.buffer && "[object ArrayBuffer]" === e.buffer.toString())) {
				var o, r = h;
				e instanceof ArrayBuffer ? (o = e, r += g) : (o = e.buffer, "[object Int8Array]" === n ? r += y : "[object Uint8Array]" === n ? r += w : "[object Uint8ClampedArray]" === n ? r += S : "[object Int16Array]" === n ? r += _ : "[object Uint16Array]" === n ? r += k : "[object Int32Array]" === n ? r += x : "[object Uint32Array]" === n ? r += I : "[object Float32Array]" === n ? r += E : "[object Float64Array]" === n ? r += O : t(new Error("Failed to get type for BinaryArray"))), t(r + l(o))
				...
				window.console.error("Couldn't convert value into a JSON string: ", e), t(n)
			}
		}
	...
	function() {
						...
						r.db.transaction(function(n) {
							n.executeSql("SELECT * FROM " + r.storeName, [], function(n, o) {
								for (var r = o.rows, i = r.length, a = 0; i > a; a++) {
									var s = r.item(a),
										c = s.value;
									if (c && (c = u(c)), void 0 !== (c = e(c, s.key))) return void t(c)
								}
								t()
							}, function(e, t) {
								o(t)
					...
					t.ready().then(function() {
						...
						o.db.transaction(function(t) {
							t.executeSql("SELECT key FROM " + o.storeName, [], function(t, n) {
								for (var o = [], r = 0; r < n.rows.length; r++) o.push(n.rows.item(r).key);
								e(o)
							}, function(e, t) {
								n(t)
							})
		...
		function l(e) {
			var t, n = new Uint8Array(e),
				o = "";
			for (t = 0; t < n.length; t += 3) o += m[n[t] >> 2], o += m[(3 & n[t]) << 4 | n[t + 1] >> 4], o += m[(15 & n[t + 1]) << 2 | n[t + 2] >> 6], o += m[63 & n[t + 2]];
			return n.length % 3 == 2 ? o = o.substring(0, o.length - 1) + "=" : n.length % 3 == 1 && (o = o.substring(0, o.length - 2) + "=="), o
		}

		function u(e) {
			if (e.substring(0, g) !== v) return JSON.parse(e);
			var t, n, o, r, i, a = e.substring(C),
				s = e.substring(g, C),
				c = .75 * a.length,
				l = a.length,
				u = 0;
			...
			var f = new ArrayBuffer(c),
				d = new Uint8Array(f);
			for (t = 0; l > t; t += 4) n = m.indexOf(a[t]), o = m.indexOf(a[t + 1]), r = m.indexOf(a[t + 2]), i = m.indexOf(a[t + 3]), d[u++] = n << 2 | o >> 4, d[u++] = (15 & o) << 4 | r >> 2, d[u++] = (3 & r) << 6 | 63 & i;
			switch (s) {
				case b:
					return f;
				case y:
		...
		function f(e, t) {
			...
			if (e && (n = e.toString()), e && ("[object ArrayBuffer]" === e.toString() || e.buffer && "[object ArrayBuffer]" === e.buffer.toString())) {
				var o, r = v;
				e instanceof ArrayBuffer ? (o = e, r += b) : (o = e.buffer, "[object Int8Array]" === n ? r += w : "[object Uint8Array]" === n ? r += S : "[object Uint8ClampedArray]" === n ? r += _ : "[object Int16Array]" === n ? r += x : "[object Uint16Array]" === n ? r += I : "[object Int32Array]" === n ? r += k : "[object Uint32Array]" === n ? r += E : "[object Float32Array]" === n ? r += O : "[object Float64Array]" === n ? r += A : t(new Error("Failed to get type for BinaryArray"))), t(r + l(o))
			} else if ("[object Blob]" === n) {
				var i = new FileReader;
				i.onload = function() {
					var e = l(this.result);
				...
				window.console.error("Couldn't convert value into a JSON string: ", e), t(null, n)
			}
		}
	...
	function() {
		...
		function t() {
			for (var e = 1; e < arguments.length; e++) {
				var t = arguments[e];
				if (t)
					for (var n in t) t.hasOwnProperty(n) && (arguments[0][n] = m(t[n]) ? t[n].slice() : t[n])
			}
			return arguments[0]
		}
		...
		function n(e) {
			for (var t in a)
				if (a.hasOwnProperty(t) && a[t] === e) return !0;
			return !1
		}

		function o(n) {
			this._config = t({}, u, n), this._driverSet = null, this._ready = !1, this._dbInfo = null;
			for (var o = 0; o < c.length; o++) e(this, c[o]);
		...
		var d = function(e) {
				var t = t || e.indexedDB || e.webkitIndexedDB || e.mozIndexedDB || e.OIndexedDB || e.msIndexedDB,
					n = {};
				return n[a.WEBSQL] = !!e.openDatabase, n[a.INDEXEDDB] = !! function() {
					if (void 0 !== e.openDatabase && e.navigator && e.navigator.userAgent && /Safari/.test(e.navigator.userAgent) && !/Chrome/.test(e.navigator.userAgent)) return !1;
					try {
			...
			p = this;
		o.prototype.INDEXEDDB = a.INDEXEDDB, o.prototype.LOCALSTORAGE = a.LOCALSTORAGE, o.prototype.WEBSQL = a.WEBSQL, o.prototype.config = function(e) {
			if ("object" == typeof e) {
			...
			var a = new r(function(t, o) {
				try {
					...
					if (!e._driver) return void o(s);
					if (n(e._driver)) return void o(l);
					for (var u = c.concat("_initStorage"), f = 0; f < u.length; f++) {
						var m = u[f];
						if (!m || !e[m] || "function" != typeof e[m]) return void o(s)
					}
					var p = r.resolve(!0);
					"_support" in e && (p = e._support && "function" == typeof e._support ? e._support() : r.resolve(!!e._support)), p.then(function(n) {
						d[a] = n, i[a] = e, t()
					}, o)
				} catch (e) {
					o(e)
			...
			var t = this,
				n = new r(function(e, n) {
					t._driverSet.then(function() {
						null === t._ready && (t._ready = t._initStorage(t._config)), t._ready.then(e, n)
					}).catch(n)
				});
			return n.then(e, e), n
			...
			var s = this;
			return "string" == typeof e && (e = [e]), this._driverSet = new r(function(t, o) {
				var a = s._getFirstSupportedDriver(e),
					c = new Error("No available storage method found.");
				if (!a) return s._driverSet = r.reject(c), void o(c);
				if (s._dbInfo = null, s._ready = null, n(a)) {
					if (f === l.DEFINE) return void require([a], function(e) {
						s._extend(e), t()
					});
					if (f === l.EXPORT) {
						var u;
					...
					if (!i[a]) return s._driverSet = r.reject(c), void o(c);
					s._extend(i[a])
				}
				t()
			}), this._driverSet.then(a, a), this._driverSet.then(t, o), this._driverSet
	...
	}.call(window), $.fn.serializeObject = function(e) {
		var t = {},
		...
		return $.each(n, function() {
			if (-1 == this.name.indexOf("xl_")) {
				...
				t[this.name] ? (t[this.name].push || (t[this.name] = [t[this.name]]), t[this.name].push(n)) : t[this.name] = n
			}
		}), t
	};
var ssc = ssc || {};
	...
	return {
		...
		submitOnceMultiForm: function() {
				...
				if (o.length > n) {
					...
					localforage.getItem(i, function(i, s) {
						if (!i) {
							...
							a += l, a <= 9e5 && n < 10 ? (c.push(o[n]), r.push(s), ++n, o.length > n ? e(n) : t()) : t()
						}
					})
				}
			}
					...
					function n(l) {
						if (c.length > l) {
							...
							localforage.removeItem(u, function(u) {
								u || (o.splice(0, 1), 0 === o.length && ssc.formSubmitModule.options.after_offlineformsubmit_callback && ssc.formSubmitModule.options.after_offlineformsubmit_callback("success", t), ssc.Global.formStorage.formStorageUpdateCallback(--s, "delete"), ++l, c.length > l ? n(l) : (a = i, c = new Array, r = new Array, e(0)))
							})
						}
					}
					n(0)
			...
			localforage.iterate(function(e, t, n) {
				...
				t > -1 && o.splice(t, 1), o.sort(function(e, t) {
					var n = e.length,
						o = t.length;
					return e.substring(8, n) - t.substring(8, o)
				}), s = o.length, ssc.Global.formStorage.formStorageUpdateCallback(s, "submit"), e(0)
			})
		},
		getJsonFormData: void 0,
		config: function(t) {
			this.options = this.options ? $.extend({}, this.options, t) : $.extend({}, e, t), this.getJsonFormData = this.options.getJsonFormData_callback
		}
	}
}();
var ssc = ssc || {};
		...
		function e(e) {
			...
			return localforage.config({
				...
				saveFormAsOfflineSubmitInStorage: function(e) {
					...
					t += ssc.utils.size(e), t > 9e5 ? "undefined" !== o && o("error", "The form is larger than the maximum size and cannot be saved.") : this.asyncGetSavedFormsCount(function(t) {
						var r = "_submit_1";
						t >= 0 && (r = "_submit_" + ++t),
							function(t) {
								localforage.setItem(r, e, function(e, r) {
									t > 0 && ("undefined" !== n && n(t, "save"), "undefined" !== o && o("success"))
								})
							}(t)
					})
				},
				restoreThisFormDataFromStorage: function(e) {
					localforage.getItem("this_form_", function(t, n) {
						if (null !== n && "object" == typeof n)
							for (var o in n) n.hasOwnProperty(o) && ssc.formBinder.bind(o, n[o]);
						e("")
					})
				},
				asyncReadEachSavedForm: function(e) {
					try {
						localforage.keys(function(t, n) {
							if (n.length > 0)
								for (var o = 0; o < n.length; o++) "_" === n[o].charAt(0) && function(t) {
				...
				asyncGetSavedFormsCount: function(e) {
					localforage.keys(function(t, n) {
						var o = 0;
						if (n.length > 0)
							for (var r = 0; r < n.length; r++) "_" === n[r].charAt(0) && o++;
						e(o)
					})
				},
				asyncGetSavedFormsKeys: function(e) {
					localforage.keys(function(t, n) {
						var o = new Array;
						if (n.length > 0)
							for (var r = 0; r < n.length; r++) "_" === n[r].charAt(0) && o.push(n[r]);
						e(o)
					})
				},
				...
				asyncRemoveAllSavedForms: function(e) {
					this.asyncGetSavedFormsKeys(function(t) {
						for (var n in t) n < t.length - 1 ? localforage.removeItem(t[n], function(e) {}) : (localforage.removeItem(t[n], function(e) {}), e())
					})
				}
			}
		}
	...
	function(e) {
		e(["jquery"], function(e) {
			return function() {
				...
				function n(t, n) {
					return t || (t = h()), g = e("#" + t.containerId), g.length ? g : (n && (g = f(t)), g)
				}
				...
				function c(t) {
					var o = h();
					return g || n(o), t && 0 === e(":focus", t).length ? void v(t) : void(g.children().length && g.remove())
				}

				function l(t) {
					for (var n = g.children(), o = n.length - 1; o >= 0; o--) u(e(n[o]), t)
				}
				...
				function p(t) {
					function o(t) {
						return !e(":focus", u).length || t ? (clearTimeout(S.intervalId), u[s.hideMethod]({
							duration: s.hideDuration,
							easing: s.hideEasing,
							complete: function() {
								v(u), s.onHidden && "hidden" !== _.state && s.onHidden(), _.state = "hidden", _.endTime = new Date, m(_)
							}
						})) : void 0
					}

					function r() {
						(s.timeOut > 0 || s.extendedTimeOut > 0) && (l = setTimeout(o, s.extendedTimeOut), S.maxHideTime = parseFloat(s.extendedTimeOut), S.hideEta = (new Date).getTime() + S.maxHideTime)
					}

					function i() {
						clearTimeout(l), S.hideEta = 0, u.stop(!0, !0)[s.showMethod]({
					...
					if (void 0 !== t.optionsOverride && (s = e.extend(s, t.optionsOverride), c = t.optionsOverride.iconClass || c), s.preventDuplicates) {
					...
					return t.iconClass && u.addClass(s.toastClass).addClass(c), t.title && (f.append(t.title).addClass(s.titleClass), u.append(f)), t.message && (d.append(t.message).addClass(s.messageClass), u.append(d)), s.closeButton && (b.addClass("toast-close-button").attr("role", "button"), u.prepend(b)), s.progressBar && (p.addClass("toast-progress"), u.prepend(p)), u.hide(), s.newestOnTop ? g.prepend(u) : g.append(u), u[s.showMethod]({
						duration: s.showDuration,
						easing: s.showEasing,
						complete: s.onShown
					}), s.timeOut > 0 && (l = setTimeout(o, s.timeOut), S.maxHideTime = parseFloat(s.timeOut), S.hideEta = (new Date).getTime() + S.maxHideTime, s.progressBar && (S.intervalId = setInterval(a, 10))), u.hover(i, r), !s.onclick && s.tapToDismiss && u.click(o), s.closeButton && b && b.click(function(e) {
				...
				if (r.crossDomain && r.async && n.test(r.type) && t.test(r.url) && o.test(r.url)) {
					...
					return {
						send: function(t, n) {
							...
							s = new XDomainRequest, /^\d+$/.test(i.timeout) && (s.timeout = i.timeout), s.ontimeout = function() {
								n(500, "timeout")
							}, s.onload = function() {
								...
								try {
									if ("html" === a || /text\/html/i.test(s.contentType)) r.html = s.responseText;
										...
										if (!i || !i.documentElement || i.getElementsByTagName("parsererror").length) throw o.code = 500, o.message = "parseerror", "Invalid XML: " + s.responseText;
										r.xml = i
									}
								} catch (e) {
									throw e
							...
							}, i.data && (o = "string" === e.type(i.data) ? i.data : e.param(i.data)), s.open(r.type, r.url), s.send(o)
						},
						abort: function() {
							s && s.abort()
						}
	...
	function(e, t) {
		...
		function n(e, t, n, o) {
			var r = ["opacity", t, ~~(100 * e), n, o].join("-"),
				...
				u = s && "-" + s + "-" || "";
			return f[r] || (l.insertRule("@" + u + "keyframes " + r + "{0%{opacity:" + a + "}" + i + "%{opacity:" + e + "}" + (i + .01) + "%{opacity:1}" + (i + t) % 100 + "%{opacity:" + e + "}100%{opacity:" + a + "}}", l.cssRules.length), f[r] = 1), r
		}
		...
		function o(e, t) {
			...
			for (o = 0; o < u.length; o++)
				if (n = u[o] + t, void 0 !== r[n]) return n
		}
		...
		if (s.defaults = {}, i(s.prototype, {
				spin: function(t) {
					...
					if (r(i, {
						...
						! function e() {
							s++;
							for (var t = 0; t < o.lines; t++) a = Math.max(1 - (s + (o.lines - t) * m) % f * d, o.opacity), n.opacity(i, t * o.direction + l, a, o);
				...
				lines: function(o, i) {
					...
					for (var l, u = 0, f = (i.lines - 1) * (1 - i.direction) / 2; u < i.lines; u++) l = r(e(), {
						position: "absolute",
			...
			!o(m, "transform") && m.adj ? function() {
				...
				l.addRule(".spin-vml", "behavior:url(#default#VML)"), s.prototype.lines = function(e, o) {
					function i() {
						return r(n("group", {
							coordsize: u + " " + u,
							coordorigin: -l + " " + -l
					...
					var c, l = o.scale * (o.length + o.width),
						u = 2 * o.scale * l,
						f = -(o.width + o.length) * o.scale * 2 + "px",
						d = r(i(), {
							position: "absolute",
							top: f,
							left: f
					...
					if (o.shadow)
						for (c = 1; c <= o.lines; c++) s(c, -2, "progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");
					for (c = 1; c <= o.lines; c++) s(c);
					return t(e, d)
				}, s.prototype.opacity = function(e, t, n, o) {
					var r = e.firstChild;
					o = o.shadow && o.lines || 0, r && t + o < r.childNodes.length && (r = r.childNodes[t + o], r = r && r.firstChild, (r = r && r.firstChild) && (r.opacity = n))
				}
			}() : c = o(m, "animation")
		}
		return s
...
ssc.Spinner = function() {
	function e(e) {
		...
		return {
			start: function() {
				e.attr("disabled", ""), e.attr("data-loading", ""), n.spin(), o.append(n.el)
			},
			stop: function() {
				n.stop(), $("[role='progressbar']").remove(), e.removeAttr("disabled"), e.removeAttr("data-loading")
			}
		}
	}
	...
	function n() {
		r = t();
		$("form").append('<div id="modalspinner" style="z-index: 10000;display: block;position:absolute!important;" class="modal">            <span class="spin" style="position: absolute;display: block;top:0;bottom:0;right:0;left:0;width: 40px;height: 40px; border-radius: 22px;background-color: #3F3F3F;z-index: 1;margin:auto;"></span>        </div>'), r.spin(), $("#modalspinner .spin").append(r.el)
	}

	function o() {
		r && (r.stop(), r = void 0), $("#modalspinner").remove()
	}
	var r = void 0;
	return {
		create: e,
	...
	e && (ssc.ssc_bs = "true" == e), ssc.utils.checkIfBrowserSupportStorageSystem();
	var t = function(e) {
		...
		$.each($("input:file"), function(e, t) {
			var n = $(t),
				o = n.data("files");
			Array.isArray(o) || (o = JSON.parse(o)), r = r.concat(o)
		});
		for (var i = r.length, a = 0; a < i; a++) o["xll_fileid" + a] = encodeURIComponent(r[a].id);
		return void 0 != o.subject && e && (o.subject = o.subject.replace(/%5Cr%5Cn/g, " ")), o
	};
	...
	}, $(".toolbar-panel-right").prepend("    <div id='offlineforms-submit' class='hideme'>        <button id='offlineforms-submit-btn' type='button' class='btn btn-offlineforms-submit btn-sm'>        <span class='offlineforms-logo'></span><span>Offline Forms</span>        <span id='x1' class='badge badge-offlineforms-submit' >0</span>        </button>    </div>"), $("#formc").prepend("<div id='formsaving' style='background-color: #FFD76E;position: fixed; left: 50%; top: 10px;z-index: 1000000; padding-left: 1em;padding-right: 1ex;text-align: center; border: 1px solid #E4C471;border-radius: 2px;' class='hideme'>saving form...</div>"), $("#formc").append(n);
	var o = "wookbook1";
	void 0 !== ssc.APPNAME && ssc.APPNAME.length > 0 && (o = ssc.APPNAME.toLowerCase()), ssc.Global = ssc.Global || {}, ssc.Global.formStorage = ssc.FormStorageClass.getInstance({
		dbName: o,
		offlineStoreUpdate: function(e, t) {
			$("#x1").html(e), $("#offlineforms-submit-conformation-modal .conform").text(e + ssc.Dialog.OfflineSubmitWaitCounter), e > 0 ? ($("#offlineforms-submit").removeClass("hideme"), $("#offlineforms-submit").addClass("showme")) : ($("#offlineforms-submit").removeClass("showme"), $("#offlineforms-submit").addClass("hideme"))
		},
		callback_AfterOfflineStore: function(e, t) {
			$("#offlineforms-save-conformation-modal").modal("hide"), "error" === e && alert(t)
		}
	}), window.origi_recalc_onclick = void 0, window.autosaveing = !1, window.repobuff = [], ssc.ssc_bs && ssc.utils.checkIfBrowserSupportStorageSystem() && (window.origi_recalc_onclick = recalc_onclick, window.recalc_onclick = function(e) {
		origi_recalc_onclick && origi_recalc_onclick(e), e.length > 0 && (window.autosaveing || (window.autosaveing = !0, setTimeout(function() {
			if ($("#formsaving").removeClass("hideme").addClass("showme"), "undefined" !== ssc.Global.formStorage) {
				var e = t(!1);
				ssc.Global.formStorage.storeThisForm(e, function(e) {
					setTimeout(function() {
						$("#formsaving").removeClass("showme").addClass("hideme")
					}, 500), window.autosaveing = !1
				})
			}
		}, 1e3)))
	}), ssc.ssc_bs && ssc.Global.formStorage.restoreThisFormDataFromStorage(recalc_onclick), ssc.Global.formStorage.asyncGetSavedFormsCount(function(e) {
		e > 0 ? ($("#offlineforms-submit").removeClass("hideme"), $("#offlineforms-submit").addClass("showme"), $("#x1").html(e)) : ($("#offlineforms-submit").removeClass("showme"), $("#offlineforms-submit").addClass("hideme"), $("#x1").html(e))
	}), $("#offlineforms-submit-btn").click(function() {
		ssc.Spinner.showModalSpinner(), ssc.formSubmitModule.callIfOnlineElse(function() {
			...
			ssc.Spinner.destroyModalSpinner(), $("#offlineforms-submit-status-modal").modal("show")
		})
		...
		ssc.formSubmitModule.callIfOnlineElse(function() {
			$("#offlineforms-submit-conformation-yes-btn").button("loading"), $("#offlineforms-submit-conformation-modal .info").text(ssc.Dialog.OfflineSubmitWait), $("#offlineforms-submit-conformation-modal .conform").text("3 Left"), $("#offlineforms-submit-conformation-modal .btn-link").hide(), ssc.formSubmitModule.submitOnceMultiForm()
		}, function() {
		...
		e.stopPropagation(), $(this).closest(".modal").modal("hide")
	}), toastr.options = {
		closeButton: !0,
		debug: !1,
		newestOnTop: !1,
...
function calc(data) {
	...
	var c1B6 = (((iserror((((c1B3) / (c1B5))))) ? ("") : (((c1B3) / (c1B5)))));
	var c1B8 = (((iserror((((((c1B5) / (c1B4))) * (1000))))) ? ("") : (((((c1B5) / (c1B4))) * (1000)))));
	var c1B10 = (((iserror((((c1B3) / (v2n(c1B8)))))) ? ("") : (((c1B3) / (v2n(c1B8))))));
	var c1A14 = (((v2n(c1B8)) / (c1B5)));
	data['XLEW_1_14_1'] = c1A14;
	data['XLEW_1_10_2'] = c1B10;
	data['XLEW_1_8_2'] = c1B8;
	data['XLEW_1_6_2'] = c1B6;
};
/*!
	...
	c.VERSION = "3.3.6", c.TRANSITION_DURATION = 150, c.DEFAULTS = {
		...
		if (this.hasContent() && this.enabled) {
			...
			if (j) {
				...
				h = "bottom" == h && k.bottom + m > o.bottom ? "top" : "top" == h && k.top - m < o.top ? "bottom" : "right" == h && k.right + l > o.width ? "bottom" : "left" == h && k.left - l < o.left ? "right" : h, f.removeClass(n).addClass(h)
			}
...
function recalc_onclick(e) {
	ssc.recalcSource = e, co.XLEW_1_3_2 = eeparseFloat(document.getElementById("XLEW_1_3_2").value), co.XLEW_1_4_2 = eeparseFloat(document.getElementById("XLEW_1_4_2").value), co.XLEW_1_5_2 = eeparseFloat(document.getElementById("XLEW_1_5_2").value), calc(co), void 0 !== ssc && void 0 !== ssc.realtimesync && void 0 !== ssc.realtimesync.connection && 1 == ssc.realtimesync.connection.readyState ? ssc.realtimesync.coUpdate(co, e) : void 0 !== ssc && void 0 !== ssc.realtimesync && ssc.realtimesync.wsUrl && ssc.realtimesync.IsCloseByError && !ssc.realtimesync.IsErrorMsgDialogShown && (alert("Realtime-Sync is Disconnected, This Form will not save in server and will not collaborate with your partner.") || (ssc.realtimesync.IsErrorMsgDialogShown = !0)), document.getElementById("XLEW_1_6_2").value = eeisnumber(co.XLEW_1_6_2) ? eedisplayFloat(co.XLEW_1_6_2) : co.XLEW_1_6_2, document.getElementById("XLEW_1_8_2").value = eeisnumber(co.XLEW_1_8_2) ? eedisplayFloat(co.XLEW_1_8_2) : co.XLEW_1_8_2, document.getElementById("XLEW_1_10_2").value = eeisnumber(co.XLEW_1_10_2) ? eedatefmt(fmtdate1, co.XLEW_1_10_2) : co.XLEW_1_10_2, document.getElementById("XLEW_1_14_1").value = eedisplayFloat(co.XLEW_1_14_1)
}
...
function round(e, t) {
	if (isFinite(e) && isFinite(t)) {
		var r = 0 > e ? -1 : 1,
			n = Math.abs(e),
			a = Math.pow(10, t);
		return r * Math.round(n * a) / a
	}
	return NaN
}

function s2n(e) {
	e = String(e).replace(eedecreg, "."), e = e.replace(eethreg, ""), e = e.replace(eecurrencyreg, "");
	var t = parseFloat(e);
	return myIsNaN(t) && (t = 0), e.search(eepercentreg) >= 0 && (t /= 100), t
}
...
function eedisplayFloat(e) {
	...
	var t = String(e);
	return near0RegExp.test(t) && (e = round(e, 8), t = String(e)), t.replace(/\./g, eedec)
}
...
function eedisplayFloatND(e, t) {
	...
	if (t > 0) {
		...
		if (a.length < 2) {
			...
			return a[0].toString() + eedec + i
		}
		var i = (a[1].toString() + "00000000000000").substring(0, t);
		return a[0].toString() + eedec + i
	}
	return r
}
...
function eedisplayFloatNDTh(e, t) {
	...
	if (t > 0) {
		...
		if (-1 != n.indexOf("E")) return n;
		var a = n.split("."),
			i = eeinsertThousand(a[0].toString());
		if (a.length < 2) {
			var o = "00000000000000".substring(0, t);
			return i + eedec + o
		}
		var o = (a[1].toString() + "00000000000000").substring(0, t);
		return i + eedec + o
	}
...
function eeinsertThousand(e) {
	...
	for (var r = "", n = e.length - 1, a = 0; n >= a; a++) a > 0 && a % 3 == 0 && (r = eeth + r), r = e.charAt(n - a) + r;
	return t + r
}

function eedatefmt(e, t) {
	if (!isFinite(t)) return Number.NaN;
	for (var r = 0, n = 0, a = "", i = e.length, o = 0; i > o; o++)
		if (e[o] > 31) a += fmtstrings[e[o] - 32];
		else switch (e[o]) {
			case 2:
				a += eemonth(t);
				break;
			case 3:
				n = eemonth(t), 10 > n && (a += "0"), a += n;
				break;
			case 4:
				a += fmtmonthnamesshort[eemonth(t) - 1];
				break;
			case 5:
				a += fmtmonthnameslong[eemonth(t) - 1];
				break;
			case 6:
				a += eeday(t);
				break;
			case 7:
				n = eeday(t), 10 > n && (a += "0"), a += n;
				break;
			case 8:
				a += fmtdaynamesshort[weekday(t, 1) - 1];
				break;
			case 9:
				a += fmtdaynameslong[weekday(t, 1) - 1];
				break;
			case 10:
				n = year(t) % 100, 10 > n && (a += "0"), a += n;
				break;
			case 11:
				a += year(t);
				break;
			case 12:
				...
				break;
			case 13:
				n = hour(t), 10 > n && (a += "0"), a += n;
				break;
			case 14:
				n = hour(t) % 12, a += 0 == n ? "12" : n % 12;
				break;
			case 15:
				n = hour(t) % 12, 0 == n ? a += "12" : (10 > n && (a += "0"), a += n);
				break;
			case 16:
				a += minute(t);
				break;
			case 17:
				n = minute(t), 10 > n && (a += "0"), a += n;
				break;
			case 18:
				a += second(t);
				break;
			case 19:
				n = second(t), 10 > n && (a += "0"), a += n;
				break;
			case 21:
			case 22:
				a += hour(t) < 12 ? "AM" : "PM";
			...
			case 23:
				...
				break;
			case 24:
				n = e[++o], a += eedisplayFloatND(t, n);
				break;
			case 25:
				n = e[++o], a += eedisplayFloatNDTh(t, n);
				break;
			case 26:
				a += eedisplayPercent(t);
				break;
			case 27:
				n = e[++o], a += eedisplayPercentND(t, n);
				break;
			case 28:
				n = e[++o], a += eedisplayPercentNDTh(t, n);
				break;
			case 29:
				n = e[++o], a += eedisplayScientific(t, n);
				break;
			case 30:
				r = e[++o], n = hour(t) + 24 * Math.floor(t), n = n.toString(), n.length < r && (a += "00000000000000".substring(0, r - n.length)), a += n
		}
	return a
}

function eeisnumber(e) {
	if (null == e || isNaN(e) || e == Number.NEGATIVE_INFINITY || e == Number.POSITIVE_INFINITY) return !1;
	switch (typeof e) {
		case "number":
			return !0;
		case "object":
...
function iserror(e) {
	return "number" == typeof e ? isNaN(e) || !isFinite(e) : !1
}
...
function jd_to_gregorian(e) {
	var t, r, n, a, i, o, s, c, u, l, f, d;
	t = Math.floor(e), r = t - GREGORIAN_EPOCH - 1, n = Math.floor(r / 146097), a = mod(r, 146097), i = Math.floor(a / 36524), o = mod(a, 36524), s = Math.floor(o / 1461), c = mod(o, 1461), u = Math.floor(c / 365), l = 400 * n + 100 * i + 4 * s + u, 4 != i && 4 != u && l++, f = t - gregorian_to_jd(l, 1, 1), d = t < gregorian_to_jd(l, 3, 1) ? 0 : leap_gregorian(l) ? 1 : 2;
	var m = Math.floor((12 * (f + d) + 373) / 367),
...
function weekday(e, t) {
	if (!isFinite(t) || !isFinite(e)) return Number.NaN;
	if (1 > t || t > 3) return Number.NaN;
...
function LoadFromQueryString() {
	var e = decodeURI(document.location.search),
		t = !1;
	e.indexOf("_readonly") > -1 && (t = !0), e.length > 0 && $.each(e.substr(1).split("&"), function(e, t) {
		var r = t.split("=");
		if (2 == r.length) {
			var n = r[0].toString(),
				a = r[1].toString();
			ssc.formBinder.bind(n, a)
		}
	})
}
...
function navigate(e) {
	...
	if (13 == t || 40 == t || 38 == t) {
		...
		if (!r.is("textarea") && (!r.is("select") || 38 != t && 40 != t)) {
			for (var n = parseInt(r.attr("data-sheet"), 10), a = parseInt(r.attr("data-row"), 10), i = parseInt(r.attr("data-col"), 10), o = !1, s = $("#sheet-" + n), c = 'input:not(":hidden,:button,[readonly=readonly],:disabled"),select,a.ui-slider-handle,textarea', u = a + 1, l = a - 1, f = u, d = l; 40 == t && f >= u || 38 == t && l >= d;) {
				var m = s.find(c).filter("[data-sheet=" + n + "][data-row=" + (38 == t ? l : u) + "][data-col=" + i + "]");
				if (m.length > 0) {
					m.focus(), m.is("input:text, textarea") && m.select(), o = !0;
					break
				}
				var g;
				void 0 == s.data("col" + i) ? (g = s.find(c).filter("[data-sheet=" + n + "][data-col=" + i + "]").map(function() {
					return parseInt($(this).attr("data-row"), 10)
				}).toArray(), s.data("col" + i, g)) : g = s.data("col" + i), f = g[g.length - 1], d = g[0];
				var h = "indexOf" in Array.prototype ? g.indexOf(a) : $.inArray(a, g);
				if (40 == t && f > a) u = g[h + 1];
				else {
					if (!(38 == t && a > d)) break;
					l = g[h - 1]
			...
			if (!o) {
				var y;
				y = 38 == t ? parseInt(r.attr("tabindex"), 10) - 1 : parseInt(r.attr("tabindex"), 10) + 1;
				var b = s.find(c).filter("[data-sheet][data-row][data-col][tabindex=" + y + "]");
				if (b.length > 0) b.is(":radio") && (b = b.filter(":checked")), b.length > 0 && (b.focus(), b.is("input:text, textarea") && b.select());
				else {
					var N = s.find(c).filter("[data-sheet][data-row][data-col][tabindex]:first");
					N.focus(), N.is("input:text, textarea") && N.select()
				}
			}
...
function resetClick() {
	void 0 !== ssc && void 0 !== ssc.realtimesync && void 0 !== ssc.realtimesync.connection && (ssc.realtimesync.connection.close(), ssc.realtimesync.connected = !1, ssc.realtimesync.ShowDisconnectAlert($(".toolbar-panel-right"))), document.formc.reset(), postcode(), LoadFromQueryString(), recalc_onclick("reset")
}
var eeisus = 1,
	eetrue = "TRUE",
	eefalse = "FALSE",
