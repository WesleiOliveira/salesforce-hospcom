({
    ...
    helperMethod: function(cmp, event, helper) {
        ...
        $("#criarSubmit").on("click", function() {
            ...
            helper.locaal = $('#local').val();
            helper.qtdd = 1;
            helper.vlr = $('#vUnit').val();
            helper.dataDeEntrega = $('#dataEntrega').val();
    ...
    criaOts: function(cmp, event, helper) {
        ...
        console.log("local", helper.locaal);
        console.log("quantidade", helper.qtdd);
        console.log("data", helper.dataDeEntrega);
        console.log("valor", helper.vlr);
        
        
        var action = cmp.get("c.gerar"); //DEFINE A CHAMADA DO MÉTODO APEX QUE IRÁ INSERIR O ITEM
        ...
        action.setParams({
            ...
            local : helper.locaal,
            quantidadeAtivo : helper.qtdd,
            data : helper.dataDeEntrega,
            valor : helper.vlr
        });
