({
    objetoConsulta: 'Contrato_de_Servi_o__c',
    campoConsulta: 'Assinante2__r.MobilePhone, Assinante2__r.Name, Assinante2__r.CPF__c, Assinante2__r.Email, Validador2__r.MobilePhone, Validador2__r.Name, Validador2__r.CPF__c, Validador2__r.Email, Validador__r.MobilePhone, Validador__r.Name, Validador__r.CPF__c, Validador__r.Email, Locat_rio_a__r.Billingcountry, Locat_rio_a__r.BillingCity, Locat_rio_a__r.Billingstate, Locat_rio_a__r.Billingpostalcode, Locat_rio_a__r.BillingStreet, Fiador__c, Fiador__r.Name, Fase__c, Fiador__r.PersonEmail, Fiador__r.CPF__pc, Conjuge_do_Fiador__c, Conjuge_do_Fiador__r.Name, Conjuge_do_Fiador__r.PersonEmail, Conjuge_do_Fiador__r.CPF__pc, Testemunha__c, Testemunha__r.FirstName, Testemunha__r.LastName, Testemunha__r.Email, Testemunha__r.CPF__c, Contato_do_Locat_rio__r.Email, Contato_do_Locat_rio__r.CPF__c, Contato_do_Locat_rio__c, Contato_do_Locat_rio__r.FirstName, Contato_do_Locat_rio__r.LastName, idDocAutentique__c, StatusAssinatura__c',
        ...
        .then(function (idsAutentique) {
            ...
            idsAutentique.forEach(function(resultado){
                ...
                if(resultado.hasOwnProperty('idDocAutentique__c')){
                    ...
                    var nomeCliente = resultado.Contato_do_Locat_rio__r.FirstName + " " + resultado.Contato_do_Locat_rio__r.LastName
                    var emailCliente = resultado.Contato_do_Locat_rio__r.Email
                    var cpfCliente = resultado.Contato_do_Locat_rio__r.CPF__c
                    ...
                    //VERIFICA SE EXISTE FIADOR
                    if(resultado.hasOwnProperty('Fiador__r')){
                    ...
                    if(resultado.hasOwnProperty('Locat_rio_a__c')){
                        var contaCidade = resultado.Locat_rio_a__r.BillingCity;
                        var contaPais = resultado.Locat_rio_a__r.BillingCountry;
                        var contaCEP = resultado.Locat_rio_a__r.BillingPostalCode;
                        var contaRua = resultado.Locat_rio_a__r.BillingStreet;
                        var contaEstado = resultado.Locat_rio_a__r.BillingState;
                    }else{
                        var contaCidade = "";
                        var contaPais = "";
                        var contaCEP = "";
    ...
    enviaAssinatura: function(cmp, event, helper, recordId){
        ...
        var action = cmp.get("c.enviarLocacao");
    ...
    consultaSignatarios: function(cmp, event, helper, fase){
        ...
        //CHAMA A FUNÇÃO
        var action = cmp.get("c.consultarLocacao");
        var recordId = cmp.get("v.recordId")
 ...
 downloadDocumento: function(cmp, event, helper){
    ...
    cancelaDocumento: function(cmp, event, helper){
        if (confirm("Deseja mesmo cancelar a assinatura deste documento?")) {
            ...
            //CHAMA A FUNÇÃO DO APEX QUE ADICIONA O ITEM
            var action = cmp.get("c.cancelarLocacao");
            var recordId = cmp.get("v.recordId")
