...
export function validaNumero(number) {
    ...
    // Regex aceita: (XX) XXXX-XXXX ou (XX) XXXXX-XXXX
...
export async function trataNumero(number) {
    ...
    // Adiciona 55 no começo se não tiver
    if (!numeros.startsWith('55')) {
        numeros = '55' + ddd + telefone;
    } else {
        numeros = '55' + ddd + telefone; // força formato
    }
...
// Função auxiliar para truncar texto (caso não exista globalmente)
